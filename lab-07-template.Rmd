...
The distribution of scores is definitely left skewed - we can also note that the mean score is 4.17 (3 s.f.) which is quite high - suggesting that students are scoring the courses quite generously. In addition, the fact that the minimum score rating is 2.3 is further evidence for this/
